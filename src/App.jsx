...
import SeniorWalkComponent from "./components/SeniorWalkComponent.jsx"
  ...
  return(
    <>
      <div class="relative">
          <HeaderComponent/>
          <HeroSection />
            <div className="space-y-32 bg-amber-50 bg-gradient-to-b from-amber-50 to-white px-12 py-36">
              <div className="flex items-center">
                  <div className="flex-1">
                          ...
                          <p className="text-6xl font-semibold text-amber-950">Building Future Leaders Through Excellence</p>
                  </div>
              ...
              {/**Visit Our School */}
              <div>
                <h6 className="pb-16 text-amber-900 text-sm tracking-wide font-extrabold opacity-80">VISIT OUR SCHOOLS</h6>
        ...
        {/**Our Community */}
        <div className="bg-gradient-to-b from-white to-amber-50 px-8 py-8">
              ...
              <div className="flex items-center justify-between">
                  ...
                  <div className="flex-1 px-16  text-center tracking-wide">
                    <p className="text-6xl font-semibold text-amber-950 ">A Community Committed to Excellence</p>
                ...
                <div className="py-32">
                 ...
                 <div className="w-1/2 pb-4">
                    <p className="text-4xl font-semibold text-amber-950">Standardize Academic Examinations & College Preparations</p>
                 </div>
                 <div className="w-full shadow-lg text-center px-4 py-4  gap-2 grid grid-cols-5 rounded-3xl bg-white">
            ...
            {/**Ready to join ACA Section */}
                 ...
                 <div className="flex space-x-16">
                    <div className="flex-1">
                      <div className="relative flex items-center justify-center h-full py-8">
                        <div className="absolute flex items-center justify-center border-4 border-white w-[80%] h-[30%] top-80 right-0 rounded-lg bg-gray-100/80 backdrop-blur-md mb-200">
                            ...
                            <img className="w-[70%] object-cover object-center h-full rounded-lg shadow-xl" src={GraduationCap} alt="graduation-cap" />
                        </div>
                    </div>
                      <div className="flex-1">
                        ...
                        <div className="flex space-x-8 flex-1">
                            ...
                            <div className="flex flex-col space-x-10 space-y-4"> 
              ...
              <div className="py-8 flex flex-col items-center  bg-gradient-to-b from-amber-50 to-white">
                <h6 className="pb-4 tracking-widest text-amber-900 text-sm  font-extrabold opacity-80">FAQs</h6>
                <h1 className="pb-8 text-amber-950 font-semibold text-6xl">Frequently Asked Questions</h1>
                ...
                <div className="w-[58%] h-0.5 bg-gray-100"></div> 
                <div  className="flex flex-col w-[60%] mx-auto  font-semibold  text-amber-950  px-2 py-4">
                 <div className="flex items-center justify-between">
              ...
              {/**Events & Blogs */}
              <div className=" mt-32 flex space-x-32 px-8 pt-8 pb-128">
              ...
              <div className="px-8 pt-16 absolute bottom-0 flex flex-col w-full  bg-amber-950 text-amber-50">
                <div className="pb-16 flex space-x-8 justify-between">
